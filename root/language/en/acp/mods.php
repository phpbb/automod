...
$lang = array_merge($lang, array(
	...
	'COULD_NOT_CHMOD_DIR'	=> 'AutoMOD was not able to set correct permissions to &quot;phpBB-ROOT/%s&quot;. AutoMOD needs write permission to that directory to work properly.<br />Please make sure PHP has write access to it.',
	'COULD_NOT_CREATE_DIR'	=> 'AutoMOD was not able to create the directory &quot;phpBB-ROOT/%s&quot;. That directory is needed for AutoMOD to work properly.<br />Please create it and make sure PHP has write access to it.',
	...
	'STORE_MISSING'	=> 'The store/ directory is missin or PHP don\'t have permission to write to it. AutoMOD needs that directory and to be able write to it to work properly. Please make sure the store/ directory exists and is writeable by PHP.',
