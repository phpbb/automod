...
$lang = array_merge($lang, array(
	...
	'AM_MOD_ALREADY_INSTALLED'	=> 'Impossible d’effectuer cette opération car ce MOD est déjà installé.',
	...
	'AUTOMOD'				=> 'AutoMOD',
	'AUTOMOD_CANNOT_INSTALL_OLD_VERSION'	=> 'Vous possédez déjà la version que vous essayez d’installer. Veuillez supprimer le répertoire install/.',
	'AUTOMOD_UNKNOWN_VERSION'	=>	'AutoMOD n’a pas pu être mis à jour car il n’a pas été possible de déterminer la version qui est actuellement installée. La version de votre installation est la %s.',
	...
	'CREATE_TABLE_EXPLAIN'	=> 'Les modifications de la base de données ont été effectuées. De plus, une permission a été assignée au rôle d’« administrateur aux pleins pouvoirs ».',
	'DELETE'			=> 'Supprimer',
	...
	'DELETE_SUCCESS'	=> 'Le MOD a été supprimé.',
	...
	'FILE_TYPE_EXPLAIN'	=> 'Ceci n’est correct qu’avec la méthode d’écriture « téléchargement du fichier compressé »',
	'FILESYSTEM_NOT_WRITABLE'	=> 'Le fichier système ne peut pas être écrit, la méthode d’écriture directe ne peut donc pas être utilisée.',
	'FIND'				=> 'Trouver',
	...
	'FORCE_CONFIRM'		=> 'La fonctionnalité permettant de forcer l’installation signifie que le MOD n’a pas été installé entièrement. Vous devrez réaliser ultérieurement quelques corrections manuelles sur votre forum afin de terminer l’installation. Souhaitez-vous continuer ?',
	...
	'INSTALL_FORCED'	=> 'Vous avez forcé l’installation de ce MOD alors que certaines erreurs sont survenues lors de l’installation du MOD. Votre forum peut être défaillant. Veuillez prendre note des actions qui ont échouées ci-dessous, puis les corriger.',
	'INSTALLED'			=> 'MOD installé',
	'INSTALLED_EXPLAIN'	=> 'Votre MOD a été installé ! Vous pouvez consulter ici certains résultats de l’installation. Veuillez noter chaque erreur et demander assistance sur <a href="http://www.phpbb.com">phpBB.com</a> ou sur <a href="http://www.phpbb.fr">phpBB.fr</a>',
	'INSTALLED_MODS'	=> 'MODs installés',
	'INSTALLATION_SUCCESSFUL'	=> 'AutoMOD a été installé. Vous pouvez à présent gérer les MODifications de phpBB par l’intermédiaire de l’onglet AutoMOD situé dans le panneau de contrôle d’administration.',
	'INVALID_MOD_INSTRUCTION'	=> 'Ce MOD détient une instruction incorrecte ou une opération « dans la ligne, trouver » a échouée.',
